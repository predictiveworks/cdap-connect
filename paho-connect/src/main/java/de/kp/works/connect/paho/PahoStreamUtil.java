package de.kp.works.connect.paho;
/*
...
import de.kp.works.stream.mqtt.paho.PahoStream;
...
public class PahoStreamUtil {
	/*
	 * mqttSecure is currently unused
	 */
	public static JavaDStream<StructuredRecord> getStructuredRecordJavaDStream(
			StreamingContext context, PahoConfig pahoConfig, List<SecureStoreMetadata> mqttSecure) {

		Properties properties = pahoConfig.toProperties();
		StorageLevel storageLevel = StorageLevel.MEMORY_ONLY_SER();

		return PahoStream.createDirectStream(context.getSparkStreamingContext(), properties, storageLevel)
