...
public class OrientSink extends BatchSink<StructuredRecord, OrientGraphWritable, NullWritable> {
	...
	@Override
	public void transform(StructuredRecord input, Emitter<KeyValue<OrientGraphWritable, NullWritable>> emitter) {
		emitter.emit(new KeyValue<>(new OrientGraphWritable(input), null));
	}
