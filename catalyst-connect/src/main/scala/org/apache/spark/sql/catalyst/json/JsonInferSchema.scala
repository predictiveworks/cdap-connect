...
import org.apache.spark.sql.catalyst.analysis.{Resolver, TypeCoercionExt}
import org.apache.spark.sql.catalyst.expressions.ExprUtils
import org.apache.spark.sql.catalyst.json.JacksonUtils.nextUntil
import org.apache.spark.sql.catalyst.util._
import org.apache.spark.sql.types.{BooleanType, DecimalType, DoubleType, LongType, NullType, StringType, TimestampType, _}
 ...
 * __KUP__
 * 
 * This class is leveraged from v2.4.x and adjusted to the
...
object JsonInferSchema {
  val structFieldComparator: Comparator[StructField] = new Comparator[StructField] {
