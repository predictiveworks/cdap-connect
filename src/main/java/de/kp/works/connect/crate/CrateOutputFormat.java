...
public class CrateOutputFormat<K extends JdbcWritable, V> extends OutputFormat<K, V> {
	...
	public String insertQuery(String table, String primaryKey, String[] fieldNames) {
		...
		if (fieldNames == null) {
			throw new IllegalArgumentException("[CrateOutputFormat] Field names may not be null");
		}
	...
	public RecordWriter<K, V> getRecordWriter(TaskAttemptContext context) throws IOException, InterruptedException {
		...
		/*
		 * In case there is no external schema provided, the list of field names is
		 * empty
		 */
