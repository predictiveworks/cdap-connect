...
@Name("KolideSource")
@Description("A Kolide streaming source to read messages from Google PubSub.")
public class KolideSource extends StreamingSource<StructuredRecord> {
	...
	private KolideConfig config;
	
	public KolideSource(KolideConfig config) {
		this.config = config;
	}
	...
	public JavaDStream<StructuredRecord> getStream(StreamingContext context) throws Exception {
		...
		return KolideStreamUtil.getStructuredRecordJavaDStream(context, config, secureData);			
