...
public final class UUIDUtil {
  ...
  public static UUID startOfJavaTimestamp(long timestamp) {
    return new UUID(makeMSB(fromJavaTimestamp(timestamp)), MIN_CLOCK_SEQ_AND_NODE);
  }
  ...
  static long fromJavaTimestamp(long tstamp) {
    return (tstamp - START_EPOCH) * 10;
  }
