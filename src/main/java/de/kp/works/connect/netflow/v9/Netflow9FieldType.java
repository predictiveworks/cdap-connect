...
public enum Netflow9FieldType {
	  ...
	  SCOPE_SYSTEM(Netflow9Field.SCOPE_FIELD_OFFSET + 1, "", "System"),
	  SCOPE_INTERFACE(Netflow9Field.SCOPE_FIELD_OFFSET + 2, "", "Interface"),
	  SCOPE_LINE_CARD(Netflow9Field.SCOPE_FIELD_OFFSET + 3, "", "Line Card"),
	  SCOPE_NETFLOW_CACHE(Netflow9Field.SCOPE_FIELD_OFFSET + 4, "", "Netflow Cache"),
	  SCOPE_TEMPLATE(Netflow9Field.SCOPE_FIELD_OFFSET + 5, "", "Template"),
	...
	Netflow9FieldType(int typeId, String lengthDescription, String typeDescription) {
	...
	public static Netflow9FieldType getTypeForId(int typeId) {
		return fieldIdToType.get(typeId);
	}

	public static Netflow9FieldType getScopeTypeForId(int scopeTypeId) {
		return fieldIdToType.get(Netflow9Field.SCOPE_FIELD_OFFSET + scopeTypeId);
	}

	private static final Map<Integer, Netflow9FieldType> fieldIdToType = new HashMap<>();
	static {
		for (Netflow9FieldType type : Netflow9FieldType.values()) {
